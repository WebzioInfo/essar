...
import { GraduationCap, Factory, Flask, ChartLineUp } from "@phosphor-icons/react";
...
export default function Founder() {
  ...
  return (
    <>
      <Head>
        <title>Founder – Essar Enterprises | RO Plant Expert</title>
        <meta name="description" content="Meet Mr. Shareef, Founder & Chairman of Essar Enterprises. 20+ years of experience in designing and managing packaged drinking water plants across South India." />
        <meta name="keywords" content="Essar Enterprises Founder, RO Plant Expert Kerala, Water Plant Consultant, Industrial Water Solutions, Mr. Shareef" />
        <meta name="robots" content="index, follow" />

        {/* Open Graph */}
        <meta property="og:title" content="Founder – Essar Enterprises | RO Plant Expert" />
        <meta property="og:description" content="Meet Mr. Shareef, Founder & Chairman of Essar Enterprises, with 20+ years of industry experience." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://essarenterprises.co.in/founder" />
        <meta property="og:image" content="https://essarenterprises.co.in/logo.png" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Founder – Essar Enterprises | RO Plant Expert" />
        <meta name="twitter:description" content="Meet Mr. Shareef, Founder & Chairman of Essar Enterprises, with 20+ years of industry experience." />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Founder", "item": "https://essarenterprises.co.in/founder" }
              ]
            })
          }}
        />
