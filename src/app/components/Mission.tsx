...
export default function Mission() {
  ...
  return (
    <section id="mission" ref={sectionRef} className="py-24 md:py-40 bg-background relative">
      {/* Subtle Glass Glow */}
      <div className="absolute inset-0 opacity-35 blur-[120px] pointer-events-none bg-linear-to-tr from-primary/20 via-transparent to-(--accent)/20" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
          ...
          <h2 className="heading-lg text-foreground mb-8 leading-tight max-w-xl">
